            ...
            {items.slice(0, limit ? limit : items.length).map((item, idx) => (
                ...
                >
                    ...
                    <Card className="rounded-2xl h-full w-full overflow-hidden bg-slate-950 border border-transparent dark:border-white/[0.2] group-hover:border-slate-700 relative z-20 flex  flex-col justify-center items-center">
                        <CardHeader>
                            <Image src={item.avatar} alt={item.name} width={300} height={300} className="rounded-full size-24" />
                        </CardHeader>
                        ...
                        <CardFooter className="flex justify-center gap-3 items-center">
                            <Link href={item.twitter} className="text-sm">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-6 fill-current hover:fill-slate-400">
                            ...
                            <Link href={item.linkedin} className="text-sm">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-6 fill-current hover:fill-slate-400">
