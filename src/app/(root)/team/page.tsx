        ...
        <section className="select-none">
            <div className="container flex flex-col items-center pt-12">
                ...
                <div className="w-full flex justify-end items-center">
                    <Button variant="ghost" size="sm" onClick={() => { router.push("/team/Teams") }}>
                        View More
                    </Button>
                </div>
            </div>
            <div className="container flex flex-col items-center pt-12">
                ...
                <HoverEffect items={dummyData} limit={4} />
                <div className="w-full flex justify-end items-center">
                    <Button variant="ghost" size="sm" onClick={() => { router.push("/team/Sponsers") }}>
                        View More
                    </Button>
                </div>
            </div>
            <div className="container flex flex-col items-center pt-12 pb-4">
                ...
                <HoverEffect items={dummyData} limit={4} />
                <div className="w-full flex justify-end items-center">
                    <Button variant="ghost" size="sm" onClick={() => { router.push("/team/contributers") }}>
                        View More
                    </Button>
                </div>
            </div>
